  ...
  return <><div>
    ...
    <main className="flex-1">
      ...
      <section>
        ...
        {/* CTA Section */}
        <section className="w-full py-16 md:py-20 px-4 bg-gradient-to-r from-primary/10 via-accent/10 to-primary/10 border-y border-border/40">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <a
              href="/contact"
              className="inline-flex px-8 py-3 bg-primary text-primary-foreground rounded-lg font-medium hover:bg-primary/90 transition-colors"
            >
